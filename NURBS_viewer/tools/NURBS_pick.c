...
void CalcRadiusStrainStress(char *filename_output,
	...
	int i, j, k, l;
	double temp_x, temp_y, temp_sin, temp_cos;
	double temp1, temp2, temp3;
		...
		for (j = 0; j < element_n_eta; j++) {
			for (k = 0; k < division_ele_xi + 1; k++) {
				for (l = 0; l < division_ele_eta + 1; l++) {
					...
					strain_rr[i][j][k][l] = strain_xx[i][j][k][l] * temp1
					                        + strain_yy[i][j][k][l] * temp2
					                        + strain_xy[i][j][k][l] * temp3;
					strain_tt[i][j][k][l] = strain_xx[i][j][k][l] * temp2
					                        + strain_yy[i][j][k][l] * temp1
					                        - strain_xy[i][j][k][l] * temp3;
					strain_rt[i][j][k][l] = - 2.0 * strain_xx[i][j][k][l] * temp3
					                        + 2.0 * strain_yy[i][j][k][l] * temp3
					                        + strain_xy[i][j][k][l] * (temp1 - temp2);
					printf("% 1.8e\t% 1.8e\t% 1.8e\t",
					       strain_rr[i][j][k][l], strain_tt[i][j][k][l], strain_rt[i][j][k][l]);

					stress_rr[i][j][k][l] = stress_xx[i][j][k][l] * temp1
					                        + stress_yy[i][j][k][l] * temp2
					                        + 2.0 * stress_xy[i][j][k][l] * temp3;
					stress_tt[i][j][k][l] = stress_xx[i][j][k][l] * temp2
					                        + stress_yy[i][j][k][l] * temp1
					                        - 2.0 * stress_xy[i][j][k][l] * temp3;
					stress_rt[i][j][k][l] = - stress_xx[i][j][k][l] * temp3
					                        + stress_yy[i][j][k][l] * temp3
					                        + stress_xy[i][j][k][l] * (temp1 - temp2);
					printf("% 1.8e\t% 1.8e\t% 1.8e\n",
