...
c     
      ...
      common grid_values, min_range, max_range, model_is_rendered
...
c     コンターマップの設定
c     call autogl_set_gray_scale_contour_map()
c     call autogl_set_contour_map_bcgyrm()
c     call autogl_set_contour_map_mbcgyr()
c     call autogl_set_contour_map_bcgyr()
