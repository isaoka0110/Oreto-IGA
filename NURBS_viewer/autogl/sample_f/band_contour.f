...
c     バンドコンターの境界線を単色の線コンタ-として描画する。 
            call autogl_set_color(0.0d0, 0.0d0, 0.0d0)
            do i_grade = 1, n_grades
               value = min_range 
     c              + (max_range - min_range) / n_grades * i_grade
